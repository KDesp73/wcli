...
fn sunny_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(sunny_ascii, .{ c, r, c, curr.condition.text, r, c, r, curr.temp_c, curr.temp_f, c, r, curr.humidity, curr.pressure_mb, c, r, curr.wind_kph, curr.wind_mph, curr.wind_degree, curr.wind_dir, c, r, ansi.FgBlack, res.location.localtime, ansi.Reset });
}
...
fn cloudy_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(cloudy_ascii, .{
        ...
        c,             r,             curr.temp_c,            curr.temp_f,         c,
        r,             curr.humidity, curr.pressure_mb,       c,                   r,
        curr.wind_kph, curr.wind_mph, curr.wind_degree,       curr.wind_dir,       c,
        r,             ansi.FgBlack,  res.location.localtime, ansi.Reset,
    });
}
...
fn rainy_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(rainy_ascii, .{
        ...
        g,             r,             curr.temp_c,            curr.temp_f,         g,
        r,             curr.humidity, curr.pressure_mb,       b,                   r,
        curr.wind_kph, curr.wind_mph, curr.wind_degree,       curr.wind_dir,       b,
        r,             ansi.FgBlack,  res.location.localtime, ansi.Reset,
    });
}
...
fn snowy_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(snowy_ascii, .{
        ...
        g,             r,             curr.temp_c,            curr.temp_f,         g,
        r,             curr.humidity, curr.pressure_mb,       ansi.FgWhite,        r,
        curr.wind_kph, curr.wind_mph, curr.wind_degree,       curr.wind_dir,       ansi.FgWhite,
        r,             ansi.FgBlack,  res.location.localtime, ansi.Reset,
    });
}
...
fn foggy_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(foggy_ascii, .{
        ...
        ansi.FgMagenta, ansi.Reset,    curr.temp_c,            curr.temp_f,         ansi.FgMagenta,
        ansi.Reset,     curr.humidity, curr.pressure_mb,       ansi.FgMagenta,      ansi.Reset,
        curr.wind_kph,  curr.wind_mph, curr.wind_degree,       curr.wind_dir,       ansi.FgMagenta,
        ansi.Reset,     ansi.FgBlack,  res.location.localtime, ansi.Reset,
    });
}
...
fn thunder_renderer(writer: std.io.AnyWriter, res: WeatherResponse) !void {
    ...
    try writer.print(foggy_ascii, .{
        ...
        ansi.FgLGrey,  ansi.Reset,    curr.temp_c,            curr.temp_f,         ansi.FgLGrey,
        ansi.Reset,    curr.humidity, curr.pressure_mb,       ansi.FgYellow,       ansi.Reset,
        curr.wind_kph, curr.wind_mph, curr.wind_degree,       curr.wind_dir,       ansi.FgYellow,
        ansi.Reset,    ansi.FgBlack,  res.location.localtime, ansi.Reset,
    });
}
